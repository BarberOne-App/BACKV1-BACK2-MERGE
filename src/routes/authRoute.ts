...
import { googleAuth, listPublicBarbershops, login, logout, me, refresh, registerBarber, registerBarbershop, registerClient, registerSuperAdmin, switchBarbershop } from "../controllers/authController.js";
